...
async def handoff_to_subagent(
    agent_name: Literal["scheduler"],
    task_description: str,
    tool_call_id: Annotated[str, InjectedToolCallId],
    ):
    """Assign a task to a sub-agent: scheduler.
    
    Args:
        agent_name: The name of the agent to handoff the task to. Valid agent names are: scheduler.
