...
from src.multi_agent.notes_generator_single_agent.graph import NotesGeneratorSingleAgent
...
from src.multi_agent.researcher_single_agent.graph import ResearcherSingleAgent
from src.multi_agent.supervisor.state import SupervisorState
from src.multi_agent.supervisor.tools import PlannerTaskSchema, handoff_to_subagent
...
class SupervisorAgent:
    def __init__(self):
        ...
        self.research_agent = ResearcherSingleAgent()
        #self.notes_generator = NotesGeneratorAgent()
        self.notes_generator = NotesGeneratorSingleAgent()
